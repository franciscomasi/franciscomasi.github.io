            ...
            $contactForm.validate({
                ...
                messages: {
                    name: {
                        ...
                        minlength   : "Su nombre debe contener más de dos caracteres."
                    },
                    email: {
                        required    : "Por favor ingrese su email",
                        minlength   : "Ingrsé un email válido"
                    },
                    message: {
                        required    : "Por favor ingrese un mensaje",
                        minlength   : "Su mensaje debe contener más de 10 caracteres"
                    }
                }
            });
                ...
                if ($contactForm.valid()){
                    $.ajax({
                        ...
                        success: function(msg) {
                            if (msg === 'SEND') {
                                response = '<div class="alert alert-success">Enviado! Gracias por escribirme - Te contactaré lo antes posible!';
                            }
                            else {
                                response = '<div class="alert alert-danger">Se produjo un error al enviar el mensaje, intente nuevamente.';
                            }
